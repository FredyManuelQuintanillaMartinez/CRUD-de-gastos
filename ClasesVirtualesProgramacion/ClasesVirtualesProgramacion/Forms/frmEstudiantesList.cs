    ...
    public partial class frmEstudiantesList : Form
    {
        ...
        private void frmEstudiantesList_Load(object sender, EventArgs e)
        {
            ...
            if (oConexion.SelectData(SelectSQL, dsClasesVirtuales.Estudiantes) != true)
                MessageBox.Show("No se ha podido cargar ningun dato de estudiantes, contacte al departamento de desarrollo tecnico", "Sin datos", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            if (frmNuevo.DialogResult == DialogResult.OK)
            {
                ...
                MessageBox.Show("La información del estudainte ha sido almacenada corerectamente.", "Guardar", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (estudiantesBindingSource.Count > 0)
            {
                if (MessageBox.Show("Asegurse de querer eliminar la informmación del estudiante, ¿Desea eliminar permanentemente este registro?", "Eliminar", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
                {
                    DataGridViewRow Fila = estudiantesDataGridView.CurrentRow;
                    Int16 ID = Int16.Parse(Fila.Cells[0].Value.ToString());
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Escriba un criterio para hacer la busqueda del estudiante", "Buscar", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                else
                {
